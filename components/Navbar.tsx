...
import NavLangButtons from './NavLangButtons'
  ...
  return (
    <header>
      ...
      "flex justify-center pt-8 pb-5 bg-stone-100"}>
        ...
        <NavButtons idioma={idioma} darkMode={darkMode} />
        <NavLangButtons idioma={idioma} darkMode={darkMode} setIdioma={setIdioma} />
        <NavMode className='px-4' darkMode={darkMode} toggleDarkMode={toggleDarkMode} />
      </nav>
    </header>
  )
}
