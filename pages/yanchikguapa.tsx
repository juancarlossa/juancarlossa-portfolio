...
export default function Counter () {
  const CountdownTimer: React.FC = () => {
    ...
    function calculateTimeRemaining (): number {
      const targetDate = new Date('2024-08-22T14:21:00').getTime();
    ...
    return (
      <div className="text-2xl w-full mt-4 font-semibold text-gray-800 bg-gradient-to-r from-cyan-300 to-purple-500 transition duration-1000 p-4 rounded-lg shadow-lg">
        ...
        <h3 className='text-center text-blue-800 font-extralight italic'>Международный аэропорт Внуково</h3>
        <h3 className='text-center text-blue-800 pb-10 font-extralight italic'>Москва, Россия</h3>
      </div>
    );
  };
